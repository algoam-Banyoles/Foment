...
workbox.precaching.precacheAndRoute([
  ...
  { url: './data/enllacos.json', revision: CACHE_VERSION },
  { url: './data/calendari.json', revision: CACHE_VERSION },
  { url: './data/festius.json', revision: CACHE_VERSION },
  { url: './data/modalitat.json', revision: CACHE_VERSION },
  { url: './data/partides.json', revision: CACHE_VERSION },
  { url: './data/classificacio.json', revision: CACHE_VERSION },
  { url: './data/inscrits.json', revision: CACHE_VERSION },
  { url: './data/manifest.json', revision: CACHE_VERSION },
  { url: './data/continu3b.json', revision: CACHE_VERSION },
  { url: './data/continu3b_auditoria.json', revision: CACHE_VERSION },
  { url: './data/continu3b_historic.json', revision: CACHE_VERSION },
  { url: './data/continu3b_jugadors.json', revision: CACHE_VERSION },
  { url: './data/continu3b_llistaespera.json', revision: CACHE_VERSION },
  { url: './data/continu3b_parametres.json', revision: CACHE_VERSION },
  { url: './data/continu3b_partides.json', revision: CACHE_VERSION },
  { url: './data/continu3b_rankingactiu.json', revision: CACHE_VERSION },
  { url: './data/continu3b_reptes.json', revision: CACHE_VERSION },
